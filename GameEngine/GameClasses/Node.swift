...
class Node {
    ...
    private var _position: SIMD3<Float> = SIMD3<Float>(0,0,0)
    private var _scale: SIMD3<Float> = SIMD3<Float>(1,1,1)
    private var _rotation: SIMD3<Float> = SIMD3<Float>(0,0,0)
